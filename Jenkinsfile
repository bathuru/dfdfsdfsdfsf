         ...
         stage('Build Helm Charts') {
            steps {
             ...
             sh "/usr/local/bin/helm package simpleapp"
					   sh "/usr/local/bin/helm push-artifactory --username srinivas.bathuru@gmail.com --password AP8d6ghvZSZjJBDbmqjqwz12opx   simpleapp-0.0.1.tgz https://bathuru.jfrog.io/artifactory/simpleapp-helm"
					  }
          }
        } 
